...
import lo02.utt.giboulot.canat.controller.AdvancedGameController;
...
public class AdvancedGame extends Game {
	...
	private int round;
	/**
	 *@see lo02.utt.giboulot.canat.card.Deck
	...
	@Override
	/**
	 * Redéfinition de la méthode designateWinner() de lo02.utt.giboulot.canat.game.Game pour correspondre aux standards de la partie avancée.
	 * @return Player
	 */
	...
	/**
	 * Constructeur de la partie avancée, utilisant le constructer de Game, il distribue aussi les cartes aux joueurs.
	...
	/**
	 * Méthode permettant de démarrer une partie avancée avec une interface graphique.
